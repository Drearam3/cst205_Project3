...
for key in MODES:
    ...
    item.pack(side='left')
'''
radio1=Radiobutton(frame, text="1", variable=v, value=1)
radio1.pack(row=0,column=0)
radio2=Radiobutton(frame, text="2", variable=v, value=2)
radio2.grid(row=0,column=1)
radio3=Radiobutton(frame, text="3", variable=v, value=3).pack(anchor=W)
radio4=Radiobutton(frame, text="4", variable=v, value=4).pack(anchor=W)
radio5=Radiobutton(frame, text="5", variable=v, value=5).pack(anchor=W)
radio6=Radiobutton(frame, text="6", variable=v, value=6).pack(anchor=W)
radio7=Radiobutton(frame, text="7", variable=v, value=7).pack(anchor=W)
'''
...
button16 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="A#4 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_As4)
button16.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=3, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button12 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="C#5 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Cs5)
button12.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=1, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button13 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="D#5 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Ds5)
button13.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=3, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button14 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="F#5 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Fs5)
button14.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=1, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button15 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="G#5 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Gs5)
button15.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=1, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button16 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="A#5 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_As5)
button16.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=3, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button17 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="C#6 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Cs6)
button17.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=1, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button18 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="D#6 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Ds6)
button18.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=3, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button19 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="F#6 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Fs6)
button19.pack(side=LEFT)

button00 = Button(topframe, state=DISABLED, padx=0, height = 7, width=1, pady=0, relief=RIDGE)
button00.pack(side=LEFT)

button19 = Button(topframe, padx=3, pady=8, width=2, height = 6, bd=8, text="G#6 ", bg="black", fg="white", activebackground="#ff4d4d", command=record_Gs6)
button19.pack(side=LEFT)
...
button24 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="C5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_C5)
button24.pack(side=LEFT)
button18 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="D5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_D5)
button18.pack(side=LEFT)
button19 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="E5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_E5)
button19.pack(side=LEFT)
button20 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="F5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_F5)
button20.pack(side=LEFT)
button21 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="G5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_G5)
button21.pack(side=LEFT)
button22 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="A5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_A5)
button22.pack(side=LEFT)
button23 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="B5 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_B5)                 
button23.pack(side=LEFT)
button24 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="C6 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_C6)
button24.pack(side=LEFT)
button25 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="D6 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_D6)
button25.pack(side=LEFT)
button26 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="E6 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_E6)
button26.pack(side=LEFT)
button27 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="F6 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_F6)
button27.pack(side=LEFT)
button28 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, text="G6 ", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_G6)
