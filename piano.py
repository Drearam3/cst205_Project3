...
button9.pack(side=LEFT)
root.bind('=', record_B2)
button10 = Button(frame1, padx=13, pady=16, width = 2, height=8, bd=0, wraplength=20, justify=CENTER, text="C3 (Q)", fg="black", bg="white", activebackground="#ff4d4d", borderwidth=1, command=record_C3)
button10.pack(side=LEFT)
